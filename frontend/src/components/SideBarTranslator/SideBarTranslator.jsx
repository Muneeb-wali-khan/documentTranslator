...
import { FaUser, FaChartBar, FaBox, FaClipboardList, FaCog, FaSignOutAlt } from 'react-icons/fa';
import { MdDashboard } from 'react-icons/md';
import { HiMenuAlt3 } from 'react-icons/hi';
import { IoMdClose } from 'react-icons/io';
import { useLogout } from '../../hooks/Logout';

const SidebarTranslator = () => {
  ...
  const menuItems = [
    { icon: MdDashboard, text: 'Dashboard', path: '/translatorPanel/dashboard' },
    { icon: FaUser, text: 'Documents', path: '/translatorPanel/allDocuments' },
    { icon: FaChartBar, text: 'Analytics', path: '/translatorPanel/analytics' },
    { icon: FaBox, text: 'Products', path: '/translatorPanel/products' },
    { icon: FaClipboardList, text: 'Orders', path: '/translatorPanel/orders' },
    { icon: FaCog, text: 'Settings', path: '/translatorPanel/settings' },
  ];
                ...
                <li key={item.text}>
                  <Link
                    ...
                    className={`
                      ...
                      ${!isActive && isItemHovered ? 'bg-gray-800 text-white' : ''}
...
export default SidebarTranslator;